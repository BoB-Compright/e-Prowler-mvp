...
export const ALL_PACKS: VendorPack[] = [osUnixPack, containerPack, osWindowsPack, webNginxPack, webApachePack, wasTomcatPack, dbMysqlPack, dbPostgresPack, dbOraclePack, webIisPack, dbMssqlPack, wasWeblogicPack, wasWebspherePack];
